...
// ── Claude AI (Anthropic) ────────────────────────────────────────────────────
const SYSTEM_PROMPT = `You are a warm, knowledgeable and friendly assistant for Moorosi Agricultural High School in Fiva Location, Ludidi A/A, Maluti, Eastern Cape, South Africa.

You help parents, learners, guardians and community members with anything about the school:
- Admissions and application process
- Required documents for applications
- School fees (No-Fee public school)
- School hours and term dates
- Staff, departments and contact information
- Academic subjects and agricultural training
...
School details:
- Name: Moorosi Agricultural High School
- Location: Fiva Location, Ludidi A/A, Maluti, 4730
- Phone: 060 886 2692
- Motto: "Invest Through Land"
- Principal: Mr W.T. Mjomle
- EMIS Number: 200501015
- Exam Centre: Moorosi Agricultural School – 4251086
...
async function askClaude(userMessage: string): Promise<string> {
  try {
    ...
    return 'I\'m having trouble connecting right now. Please contact the school directly at 060 886 2692.';
  }
}
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      role: 'bot',
      createdAt: Date.now(),
      text: "👋 Hello! I'm the Moorosi Agricultural High School assistant. Ask me anything about admissions, subjects, facilities, learnerships, or school life — I'll be happy to help!",
    },
  ]);
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          id: uid(),
          role: 'bot',
          text: 'Something went wrong. Please contact the school at 060 886 2692 or message us on Facebook: Moorosi Agricultural High School.',
          createdAt: Date.now(),
        },
      ]);
    } finally {
          ...
          <div className="flex items-center justify-between px-4 py-3 bg-school-green text-white shrink-0">
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              <div className="min-w-0">
                <div className="font-bold text-sm leading-tight truncate">Moorosi AHS Assistant</div>
